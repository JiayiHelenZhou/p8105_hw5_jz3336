...
__Comment:__ Power is positively related to effect size. Under the null hypothesis of mu = 0, as the effect size (mu) increased from 1 to 6, the power also increased and reached the highest value 1 when effect size is 4.
